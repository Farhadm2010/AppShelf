...
struct AppGridView: View {
    ...
    var page: AppPage { vm.pages[pageIndex] }
                        ...
                        if isEditingTitle {
                            TextField("Page name", text: $titleInput)
                                ...
                                .onSubmit {
                                    ...
                                    if !t.isEmpty { vm.pages[pageIndex].title = t }
    ...
    func handleDrop(providers: [NSItemProvider], ontoItem: PageItem, atIndex: Int) -> Bool {
        ...
        providers.first?.loadObject(ofClass: NSString.self) { nsItem, _ in
